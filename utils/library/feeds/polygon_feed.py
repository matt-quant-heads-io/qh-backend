...
class PolygonFeed(object):
    ...
    def __init__(self, cluster: str, auth_key: str, process_message: Optional[Callable[[str], None]] = None,
        ...
        self.ws = websocket.WebSocketApp(self.url, on_open=self._default_on_open(),
        ...
        #  We may want to define our own signal handler at lower level at some point.
        #  Must make sure that killing, terminating, interrupting the program closes the connection
